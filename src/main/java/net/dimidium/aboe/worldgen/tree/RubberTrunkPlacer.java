...
import net.dimidium.aboe.handler.registry.TrunkPlacerRegistry;
...
public class RubberTrunkPlacer extends TrunkPlacer
{
    ...
    //TODO add growable rubber to the trees
    public static final Codec<RubberTrunkPlacer> CODEC = RecordCodecBuilder.create(pineTrunkPlacerInstance ->
            trunkPlacerParts(pineTrunkPlacerInstance).apply(pineTrunkPlacerInstance, RubberTrunkPlacer::new));
